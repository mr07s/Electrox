...
import useTrait from "../components/Layout/hooks/useTrait";
const HomePage = () => {
        ...
        <div className="homepage_container">
          {sidebar === 0 ? (
            <div className="filter_btn_container">
              <button onClick={() => setSidebar(1)} className="filter_btn">
                Filters
              </button>
            </div>
          ) : (
     ...
     {JSON.stringify(radio,null,4)}
              ...
              <div className="filter_by_price">
                ...
                <Radio.Group
                  ...
                  className="filter_radiogroup"
                >
                  {Prices?.map((p) => (
                    <div key={p._id}>
                      <Radio value={p.array} className="filter_radiobutton">
                        {p.name}
                      </Radio>
                    </div>
                  ))}
          ...
          <div className="all_products">
            ...
            <div className="total_product_count">
              {products && products.length < totalProducts && (
                <button
                  className="btn load_products"
                  onClick={(e) => {
                    e.preventDefault();
                    setPage(page + 1);
                  }}
